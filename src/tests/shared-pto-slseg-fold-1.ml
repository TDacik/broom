(* Testcase building a formula with a Slseg with %l4 as shared variable and a pointer to this Slseg and a pointer to %l4: 
(%l1+8) -(8)->%l4 * Slseg(%l2, %l3, lambda-1:2, [%l4])  * %l4 -(8)->Undef * %l1 -(8)->%l2
---------------
